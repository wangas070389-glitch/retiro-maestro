import { FileSignature, CalendarDays, ShieldCheck, ArrowRight } from 'lucide-react';
...
export const DocumentHub: React.FC<DocumentHubProps> = ({ isLocked, isB2C, userProfile, calendarData }) => {
    return (
        <div>
